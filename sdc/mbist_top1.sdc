...
# Wed Dec 14 13:49:09 2022
###############################################################################
current_design mbist_top1
###############################################################################
# Timing Constraints
###############################################################################
...
set_output_delay -0.5000 -clock [get_clocks {bist_mem_clk_a}] -min -add_delay [get_ports {mem_addr_a[8]}]
set_output_delay 4.0000 -clock [get_clocks {bist_mem_clk_a}] -max -add_delay [get_ports {mem_addr_a[8]}]
...
set_output_delay -0.5000 -clock [get_clocks {bist_mem_clk_b}] -min -add_delay [get_ports {mem_addr_b[8]}]
set_output_delay 4.0000 -clock [get_clocks {bist_mem_clk_b}] -max -add_delay [get_ports {mem_addr_b[8]}]
...
set_load -pin_load 0.0334 [get_ports {wb_adr_i[8]}]
