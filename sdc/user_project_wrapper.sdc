...
set_multicycle_path -hold\
    -from [list [get_ports {wbs_adr_i[0]}]\
           ...
           [get_ports {wbs_cyc_i}]\
           [get_ports {wbs_dat_i[0]}]\
           [get_ports {wbs_dat_i[10]}]\
           [get_ports {wbs_dat_i[11]}]\
           [get_ports {wbs_dat_i[12]}]\
           [get_ports {wbs_dat_i[13]}]\
           [get_ports {wbs_dat_i[14]}]\
           [get_ports {wbs_dat_i[15]}]\
           [get_ports {wbs_dat_i[16]}]\
           [get_ports {wbs_dat_i[17]}]\
           [get_ports {wbs_dat_i[18]}]\
           [get_ports {wbs_dat_i[19]}]\
           [get_ports {wbs_dat_i[1]}]\
           [get_ports {wbs_dat_i[20]}]\
           [get_ports {wbs_dat_i[21]}]\
           [get_ports {wbs_dat_i[22]}]\
           [get_ports {wbs_dat_i[23]}]\
           [get_ports {wbs_dat_i[24]}]\
           [get_ports {wbs_dat_i[25]}]\
           [get_ports {wbs_dat_i[26]}]\
           [get_ports {wbs_dat_i[27]}]\
           [get_ports {wbs_dat_i[28]}]\
           [get_ports {wbs_dat_i[29]}]\
           [get_ports {wbs_dat_i[2]}]\
           [get_ports {wbs_dat_i[30]}]\
           [get_ports {wbs_dat_i[31]}]\
           [get_ports {wbs_dat_i[3]}]\
           [get_ports {wbs_dat_i[4]}]\
           [get_ports {wbs_dat_i[5]}]\
           [get_ports {wbs_dat_i[6]}]\
           [get_ports {wbs_dat_i[7]}]\
           [get_ports {wbs_dat_i[8]}]\
           [get_ports {wbs_dat_i[9]}]\
           [get_ports {wbs_sel_i[0]}]\
           [get_ports {wbs_sel_i[1]}]\
           [get_ports {wbs_sel_i[2]}]\
           [get_ports {wbs_sel_i[3]}]\
           [get_ports {wbs_we_i}]] 2
