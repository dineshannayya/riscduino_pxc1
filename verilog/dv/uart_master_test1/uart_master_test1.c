...
/*
	Wishbone Test:
		- Remove the User Wishbone Reset
		- Disable the User Uart Master Auto Baud Detection function
        - Enable the Uart Master Core
        - Set the Uart Master Baud Rate
*/
int i = 0; 
int clk = 0;
int uart_cfg = 0;
void main()
{
	...
	*/
    ...
    // Remove Reset + Disable Uart Auto Baud Detection
    reg_mprj_wbhost_ctrl = 0x40000007;
