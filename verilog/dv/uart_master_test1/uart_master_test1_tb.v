...
/***************************************************
   This test uses complete caravel setup and boot from UART master 
   using LA config from caravel processor
***************************************************************************/
...
reg            test_fail     ;
	...
	initial begin
           ...
           // Remove Wb Reset + Remove UART Master Auto Boot
           //uartm_reg_write(`ADDR_SPACE_WBHOST+`WBHOST_GLBL_CFG,'h4000_0007);
