...
#define reg_mprj_motor_config       (*(volatile uint32_t*)0x30000040)
#define reg_mprj_motor_multiplier   (*(volatile uint32_t*)0x30000044)
#define reg_mprj_motor_divider      (*(volatile uint32_t*)0x30000048)
#define reg_mprj_motor_period       (*(volatile uint32_t*)0x3000004C)
#define reg_mprj_motor_control      (*(volatile uint32_t*)0x30000050)
